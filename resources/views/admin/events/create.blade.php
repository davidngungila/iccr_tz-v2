...
@section('subtitle', 'Add a new event')

@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900">Create New Event</h1>
    <p class="text-gray-600 mt-2">Add a new event to display on the website</p>
</div>
    ...
    <form action="{{ route('admin.events.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" id="title_sw" name="title_sw" value="{{ old('title_sw') }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="description_sw" name="description_sw" rows="3"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('description_sw') }}</textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea name="content_sw" id="content_sw" class="hidden">{{ old('content_sw') }}</textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="full_details" name="full_details" rows="6"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('full_details') }}</textarea>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="full_details_sw" name="full_details_sw" rows="6"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('full_details_sw') }}</textarea>
        </div>
        ...
        <div class="mb-8 p-6 bg-purple-50 rounded-lg border-2 border-purple-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <input type="url" id="prayer_meeting_link" name="prayer_meeting_link" value="{{ old('prayer_meeting_link') }}"
                ...
                <div>
                    ...
                    <input type="text" id="prayer_meeting_code" name="prayer_meeting_code" value="{{ old('prayer_meeting_code') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                </div>
            </div>
            <div class="mb-4">
                ...
                <textarea id="prayer_schedule" name="prayer_schedule" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ old('prayer_schedule') }}</textarea>
            </div>
            <div>
                ...
                <textarea id="prayer_schedule_sw" name="prayer_schedule_sw" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">{{ old('prayer_schedule_sw') }}</textarea>
            </div>
        </div>
        ...
        <div class="mb-8 p-6 bg-green-50 rounded-lg border-2 border-green-200">
            ...
            <div class="mb-4">
                ...
                <textarea id="payment_info" name="payment_info" rows="5"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('payment_info') }}</textarea>
            </div>
            <div>
                ...
                <textarea id="payment_info_sw" name="payment_info_sw" rows="5"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">{{ old('payment_info_sw') }}</textarea>
            </div>
        </div>
        ...
        <div class="mb-8 p-6 bg-blue-50 rounded-lg border-2 border-blue-200">
            ...
            <div class="mb-4">
                ...
                <textarea id="registration_info" name="registration_info" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('registration_info') }}</textarea>
            </div>
            <div>
                ...
                <textarea id="registration_info_sw" name="registration_info_sw" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('registration_info_sw') }}</textarea>
            </div>
        </div>
        ...
        <div class="mb-8 p-6 bg-yellow-50 rounded-lg border-2 border-yellow-200">
            ...
            <div class="mb-4">
                ...
                <textarea id="schedule" name="schedule" rows="6"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent">{{ old('schedule') }}</textarea>
            </div>
            <div>
                ...
                <textarea id="schedule_sw" name="schedule_sw" rows="6"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent">{{ old('schedule_sw') }}</textarea>
            </div>
        </div>
...
<script>
    ...
    @if(old('content_sw'))
        quillSw.root.innerHTML = {!! json_encode(old('content_sw')) !!};
    @endif
