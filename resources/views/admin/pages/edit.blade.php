...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Update page information</p>
</div>
    ...
    <form action="{{ route('admin.pages.update', $page) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea id="content" name="content" rows="10"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('content', $page->content) }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                ...
                <input type="text" id="route_name" name="route_name" value="{{ old('route_name', $page->route_name) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="meta_description" name="meta_description" rows="3"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('meta_description', $page->meta_description) }}</textarea>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                <label for="view_path" class="block text-sm font-medium text-gray-700 mb-2">View Path</label>
                <input type="text" id="view_path" name="view_path" value="{{ old('view_path', $page->view_path) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
