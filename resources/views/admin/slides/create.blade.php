...
@section('subtitle', 'Add a new carousel slide to the homepage')

@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900">Create Carousel Slide</h1>
    <p class="text-gray-600 mt-2">Add a new slide to the homepage carousel</p>
</div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                  placeholder="Additional description text...">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <div id="image_preview" class="mt-4 hidden">
                        <img id="preview_img" src="" alt="Preview" class="max-w-md h-48 rounded-lg shadow-lg">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="animation_type" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="slide-fade" {{ old('animation_type') == 'slide-fade' ? 'selected' : '' }}>Fade In</option>
                            <option value="slide-left" {{ old('animation_type') == 'slide-left' ? 'selected' : '' }}>Slide from Left</option>
                            <option value="slide-right" {{ old('animation_type') == 'slide-right' ? 'selected' : '' }}>Slide from Right</option>
                            <option value="slide-zoom" {{ old('animation_type') == 'slide-zoom' ? 'selected' : '' }}>Zoom In</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="gradient_from" value="{{ old('gradient_from', 'green-600') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                               placeholder="green-600">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Gradient Via</label>
                        <input type="text" name="gradient_via" value="{{ old('gradient_via', 'blue-600') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                               placeholder="blue-600">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Gradient To</label>
                        <input type="text" name="gradient_to" value="{{ old('gradient_to', 'green-800') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="button_1_text" value="{{ old('button_1_text') }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                       placeholder="Join Us">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Button URL</label>
                                <input type="url" name="button_1_url" value="{{ old('button_1_url') }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Button Text</label>
                                <input type="text" name="button_2_text" value="{{ old('button_2_text') }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                       placeholder="View Events">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Button URL</label>
                                <input type="url" name="button_2_url" value="{{ old('button_2_url') }}"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                       placeholder="https://example.com">
                            </div>
                        </div>
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="urgent_badge_text" value="{{ old('urgent_badge_text', '🔥 URGENT') }}"
                               class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                               placeholder="🔥 URGENT">
                    </div>
                </div>
